...
private fun Home(entries: List<Entry>, padding: PaddingValues, onAdd: () -> Unit) {
    ...
    LazyColumn(
        ...
        item {
            Text("Ringkasan Keuangan", 24.sp, fontWeight = FontWeight.Bold)
...
private fun SummaryCard(title: String, amount: Long, color: Color) {
    Card(Modifier.fillMaxWidth()) {
        Column(Modifier.padding(18.dp)) {
            ...
            Text(formatMoney(amount), 22.sp, fontWeight = FontWeight.Bold, color = color)
        }
    }
}
...
private fun TransactionPage(
    ...
    LazyColumn(
        ...
        item {
            Text("Transaksi", 25.sp, fontWeight = FontWeight.Bold)
...
private fun ReportPage(entries: List<Entry>, padding: PaddingValues) {
    ...
    Column(
        ...
        Text("Laporan", 25.sp, fontWeight = FontWeight.Bold)
